...
import { QrCode, LayoutDashboard, UtensilsCrossed, Table2, Building2, CreditCard, ShoppingBag, LogOut, Settings, ChevronRight } from 'lucide-react'
...
export default function Sidebar({ role, restaurantName, pendingOrders }: SidebarProps) {
  ...
  return (
    <aside className="flex flex-col w-60 min-h-screen bg-surface-950 border-r border-slate-800/80">
      {/* Brand */}
      <div className="px-5 py-5 border-b border-slate-800/60">
        <Link href={role === 'super_admin' ? '/super-admin' : '/dashboard'} className="flex items-center gap-2.5">
